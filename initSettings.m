...
% based only. 
% int8 : skipNumberOfBytes = 1(Byte)*2*samplingFreq*T_skip
%        【eg】:10min= 10*60*2*30.69*10^6
settings.skipTime = 1800; % [s]


%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName           = 'E:\X310data\230919110036.A.gns';
...
settings.skipNumberOfBytes = settings.skipTime * settings.fileType * settings.samplingFreq * LenofDataByte;
